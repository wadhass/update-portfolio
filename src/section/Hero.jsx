...
const Hero = () => {
  ...
  return (
    <main
      id="home"
      className="relative flex flex-col lg:flex-row items-center h-[100vh] gap-6 px-5 md:px-8 lg:px-10 bg-cover bg-center bg-origin-padding text-black z-0"
    ...
    >
      ...
      <div className="w-full lg:w-3/5 space-y-5 z-10 text-center lg:text-left px-2 sm:px-5">
        ...
        <button
          ...
          className="bg-blue-700 text-white text-sm sm:text-base md:text-lg py-3 px-6 sm:py-4 sm:px-10 rounded-full hover:bg-blue-800 focus:ring-[2px] focus:ring-red-700 focus:ring-offset-[1px] outline-none"
        >
          Hire Me
        </button>
      </div>
